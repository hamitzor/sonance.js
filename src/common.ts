import { RtAudioErrorType, RtAudioFormat } from '@hamitzor/rtaudio.js'

export const rtAudioFormatToByteCount = (format: RtAudioFormat) => {
  switch (format) {
...
export const getReadableErrorMessage = (errType: RtAudioErrorType, message: string) => {
  switch (errType) {
